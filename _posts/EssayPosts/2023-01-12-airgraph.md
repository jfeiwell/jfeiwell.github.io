...
![real airgraph envelopes & an ad for sending option](/assets/ag_examples.png)
<p align = "center" style="margin:auto font-size:12px padding-bottom:6px">
...
makes it hard to communicate and much harder to find and use information than it should be. It’s resulted in an overload of information that’s impossible to manage. This is exacerbated by the fact that we live in a world where communication comes in the form of tens, hundreds, or thousands of people on your team across different locations and time zones.
